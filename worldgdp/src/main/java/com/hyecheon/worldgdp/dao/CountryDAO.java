...
import com.hyecheon.worldgdp.dao.mapper.CountryRowMapper;
...
public class CountryDAO {
    ...
    public List<Country> getCountries(Map<String, Object> params) {
        ...
        return namedParamJdbcTemplate.query(SELECT_CLAUSE
                + " WHERE 1 = 1 "
                + (!StringUtils.isEmpty(params.get("search"))
                ? SEARCH_WHERE_CLAUSE : "")
                + (!StringUtils.isEmpty(params.get("continent"))
                ? CONTINENT_WHERE_CLAUSE : "")
                + (!StringUtils.isEmpty(params.get("region"))
                ? REGION_WHERE_CLAUSE : "")
    ...
    public Country getCountryDetail(String code) {
        ...
        return namedParamJdbcTemplate.queryForObject(SELECT_CLAUSE + " WHERE c.code = :code", params, new CountryRowMapper());
    }
    ...
    private Map<String, Object> getCountryAsMap(String code, Country country) {
        var countryMap = new HashMap<String, Object>();
